...
//---------------------
int mr1 = 9;   // motor left  pin 12 -> IN3
int mr2 = 10;   // motor left  pin 13 -> IN4
int pmwr = 8;  // motor left  Pulse Width Modulation -> EN2
//----------------------

int ml1 = 13;  // motor right pin 8 -> IN1
int ml2 = 12; // motor right pin 9 -> IN2
int pmwl = 11; // motor right Pulse Width Modulation -> EN1
...
{ 
 ...
 if ( R == 100 ) // 00100 -> forward
    ...
    Motors(Speed, 0);
  else if ( R == 10000 || R == 11100 || R == 11110 )  
  //left
    Motors(Speed, -Speed);
